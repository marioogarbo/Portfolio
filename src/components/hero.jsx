    ...
    <main className="flex flex-col items-center justify-center">
      ...
      >
        ...
        >
          ...
          about creating <span className="font-bold">web</span> experiences. I
          enjoy building{" "}
          <span className="italic">dynamic sites and applications</span>. My
          stack is <span className="underline">MENR</span>.
        </motion.p>
